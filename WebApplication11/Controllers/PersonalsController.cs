...
namespace WebApplication11.Controllers
{
    public class PersonalsController : Controller
    {
        ...
        public PersonalsController(MiContexto context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("PersonalId,Nombre,Puesto,CorreoElectronico,Telefono")] Personal personal)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PersonalId,Nombre,Puesto,CorreoElectronico,Telefono")] Personal personal)
        {
